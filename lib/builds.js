...
const CATEGORIES = {
  ...
  business:{title:"Business",      count:"06 · tools & case studies",note:"Tools, guides, and case studies built for my shop — each one transferable. If it worked for a jewellers in Cork, it'll work for your shop too."},
  ...
  },
  {
    ...
    items:[
      ...
      {name:"Touchline", status:"wip", build:"touchline",
        desc:"A Fantasy Premier League model that rates every player twice a day and shows its working. Built and deployed — but unproven until real results land, so it stays in The Lab."},
      ...
      {name:"Personal Advisory Board", status:"ready", build:"advisoryboard",
        desc:"A 19-seat round table for any decision — 18 named advisors argue it out in their own voices, vote YES / NO / MAYBE, then Claude synthesises the consensus and the one risk to watch."}
    ]
  },
  {
...
const BUILDS = [
  ...
  {
    id:"advisoryboard", cat:"business", status:"ready", kicker:"19-persona strategic round table",
    name:"Personal Advisory Board",
    card:"Pulls 18 business and personal-development voices — Hormozi, Naval, Buffett, Sinek and more — into a round-table debate on any decision you bring, with a real vote at the end.",
    summary:"A Claude Project prompt that turns every message into a structured advisory board session. 18 named personas argue, agree, disagree and vote on whatever you bring — a business call, a habit, a pricing decision — then Claude synthesises the consensus and the single biggest risk to watch. No blended generic advice — actual named positions and a tally.",
    actions:[{label:"Download the prompt (free)",type:"primary",href:"/downloads/personal-advisory-board-AdamReflects.md"},{label:"Read the case study (coming soon)",type:"ghost"}],
    facts:[{k:"Built",v:"August 2026"},{k:"Format",v:"Claude Project custom instructions (.md)"},{k:"Cost",v:"Free — runs on your existing Claude plan"},{k:"Setup time",v:"2 minutes"}],
    tech:[
      {t:"Claude Projects",why:"Custom instructions apply automatically to every chat in the project",cost:"Free (Pro plan)"}
    ],
    flow:["Paste the prompt into a new Claude Project's custom instructions","Bring any decision, idea, or problem — no need to mention 'the board'","5–8 relevant advisors speak in their own voice, with real cross-talk","Each casts YES / NO / MAYBE with a one-line reason","Claude, the 19th seat, synthesises the consensus and the risk to watch"],
    blocks:[
      {h:"Why I built it",p:["Most 'AI advisor' prompts collapse into one generic paragraph. This forces real disagreement onto the table — a Hormozi 'no' next to a Cialdini 'yes' — so you see the actual trade-off instead of an averaged-out answer.","It's not roleplay for its own sake. Every persona is locked to a consistent worldview, and the vote count keeps it honest — you can't quietly steer it toward the answer you wanted."]}
    ]
  },
  {
