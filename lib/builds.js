...
const BUILDS = [
  ...
  /* ---------------- THE LAB ---------------- */
  {
    ...
    flow: [
      "Say 'Alexa, ask Morning Brief for my brief'",
    ...
    blocks: [
      ...
      },
      {
        ...
        p: [
          ...
          "The shorter 'Alexa, open Morning Brief' phrasing doesn't reliably fire. 'Alexa, ask Morning Brief for my brief' does, every time, so that's the one we use.",
