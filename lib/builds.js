...
const TIMELINE = [
  ...
  },
  {
    ...
    note:"Fewer new builds, more finishing. Shipping what was nearly done and going back over the site to fix what I'd rushed the first time.",
    items:[
...
const BUILDS = [
  ...
  /* ---------------- HEALTH & LIFE ---------------- */
  {
    ...
    card:"Enter your own blood results and see them explained in plain English, with a general reference range beside each one. Log your training, supplements and measurements, then print a summary for your next appointment.",
    summary:"A single web page that holds your own health numbers in one place. Type in your blood results and it shows a general reference range beside each marker, explains in plain English what each one measures, and flags anything sitting outside. Every range is editable, so you can put your own lab's numbers in. It also logs training with distance and pace, supplements, weight and blood pressure. It ships completely empty, everything stays in your browser, and it is not medical advice.",
    actions:[
      {label:"Open the dashboard",type:"primary",href:"/downloads/longevity-dashboard.html"},
      {label:"Download the blood results prompt",type:"ghost",href:"/downloads/blood-results-explainer-prompt.md"}
    ],
    facts:[{k:"Status",v:"Ready to use"},{k:"Your data",v:"Never leaves your device"},{k:"Not",v:"Medical advice"},{k:"Cost",v:"Free"}],
    tech:[
    ...
    flow:["Get your bloods done","Type in your own numbers","Correct the ranges to your lab's","See each marker explained plainly","Log training and supplements","Print a summary for your GP"],
    blocks:[
