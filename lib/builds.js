...
const CATEGORIES = {
  ...
  business:{title:"Business",      count:"05 · tools & case studies",note:"Real things I built for my own businesses, plus tools and guides for other small shops. These teach by example. Swouch is one I'm growing myself, so it's here to show, not to take."},
  lab:     {title:"The Lab",       count:"experiments & half-builds",note:"Honest corner. Things I've started, things I made only for myself, things that may never be finished. Shared anyway — because the trying is the point."},
  other:   {title:"Other",         count:"01 · and growing",      note:"The odds and ends that don't sit neatly anywhere else — starting with this very website."}
};
...
const TIMELINE = [
  ...
  },
  {
    ...
    items:[
      ...
      {build:"alexa", name:"Alexa Morning Briefing", status:"wip",
        desc:"A household voice briefing — two calendars, Cork weather, kids' bits and pieces. Scoped and planned; build waiting on an AWS account."},
  ...
  },
  {
    ...
    items:[
      ...
      {build:"alexa", name:"Alexa Morning Briefing — pending", status:"wip",
        desc:"Ready to build once the AWS account is set up. On the list."}
    ]
  }
];
...
const BUILDS = [
  /* ---------------- AI TOOLS ---------------- */
  {
    ...
    actions:[{label:"Open PromptForge",type:"primary"},{label:"Download the Constitution prompt (PDF)",type:"ghost",href:"/downloads/Personal-Constitution-Prompt.pdf"},{label:"Or grab the plain text",type:"ghost",href:"/downloads/Personal-Constitution-Prompt.txt"}],
  ...
  },
  {
    ...
    actions:[{label:"Read the guide",type:"primary"},{label:"Download",type:"ghost"}],
...

  {
    ...
    actions:[{label:"Get the skill",type:"primary"},{label:"See an example",type:"ghost"}],
  ...
  },
  {
    ...
    actions:[{label:"Open the tool",type:"primary"},{label:"Download",type:"ghost"}],
  ...
  /* ---------------- BUSINESS ---------------- */
  {
    ...
    actions:[{label:"Read the case study",type:"primary"},{label:"Visit the shop",type:"ghost",href:"https://bellejewellery.ie"}],
  ...
  },
  {
    ...
    card:"An offline Excel workbook where all the detail lives — so I can deep-dive a single day's sales or zoom out and compare month against month, year on year.",
    summary:"An offline Excel workbook that's the home for all the detail. Want to deep-dive what sold on a random Tuesday? It's there. Want to zoom out and compare this month to the same month last year? Also there. The place I go when I need to actually understand the numbers.",
    actions:[{label:"Read how it works",type:"primary"}],
    facts:[{k:"Status",v:"In use"},{k:"Lives",v:"Offline in Excel"},{k:"Built for",v:"My own shop"},{k:"Type",v:"Case study"}],
    tech:[
  ...
  },
  {
    ...
    actions:[{label:"Read the guide",type:"primary"},{label:"Visit the shop",type:"ghost",href:"https://bellejewellery.ie"}],
    ...
    blocks:[
      ...
      {label:"The guide",h:"How to set it up yourself — with Claude alongside Shopify",p:["Rather than just tell you what I did, I've written an easy, step-by-step guide so you can do the same for your own shop. It includes how to connect Claude to Shopify so the AI can work directly alongside your store — auditing pages, drafting descriptions, and helping you fix things without you needing to be technical.","It's the closest thing here to \"here's a repeatable recipe\" — no code to download, just a clear path to follow."],honest:"Nobody teaches small-shop owners this stuff plainly. It's either agency jargon or it's expensive. So I wrote the version I needed."}
    ]
  },
  {
    id:"swouch", cat:"business", status:"mine", kicker:"Case study · my own venture",
    name:"Swouch",
  ...
  /* ---------------- THE LAB ---------------- */
  {
    id:"alexa", cat:"lab", status:"wip", kicker:"Experiment · voice",
    name:"Alexa Morning Briefing",
    card:"A morning briefing skill for the whole family — something for me, something for my wife, and something for each of our three kids when they ask 'Alexa, what's my morning brief?'",
    summary:"A morning briefing skill for the whole family. Something for me, something for my wife, and something personal for each of our three children when they ask 'Alexa, what's my morning brief?' Because people hear faster than they read.",
    actions:[{label:"Follow the build",type:"primary"}],
    facts:[{k:"Status",v:"Work in progress"},{k:"Platform",v:"Alexa"},{k:"Your details",v:"Never shipped"},{k:"Held up by",v:"AWS ID approval"}],
    tech:[
      {t:"Alexa Skills Kit",why:"Amazon's framework for building custom Alexa skills. It's how you teach Alexa to answer 'what's my morning brief?'",cost:"Free",url:"https://developer.amazon.com/alexa"},
      {t:"AWS",why:"Runs the skill's logic in the background. This is exactly where I'm stuck — waiting on my account ID to be approved.",cost:"Free tier",url:"https://aws.amazon.com"},
      {t:"Google Calendar API",why:"Planned — so the brief can read the family's real calendars. Not wired up yet.",cost:"Free",url:"https://developers.google.com/calendar"}
    ],
    flow:["Say 'Alexa, what's my morning brief?'","It knows who's asking","Pulls calendars & Cork weather","Adds each person's own bit","Reads the day aloud","Everyone starts the day set up"],
    blocks:[
      {label:"Why I'm building it",h:"People hear faster than they read",p:["Mornings in a house with three kids are chaos. I love the idea of Alexa reading out the day — something for me, something for my wife, and something individual for each of my three children, each morning when they ask. A calm, personal anchor to the day. And the honest truth behind it: people hear faster than they read."]},
      {label:"What it'll do",h:"The family's day, read aloud",p:["It'll pull our calendars and the Cork weather, and give each person their own little briefing when they ask. I'm building it as a shell anyone could set up for their own household — <strong>none of my family's actual details will ever ship with it.</strong> You'd plug in your own."]},
      {label:"Where it's at",h:"Stuck on the plumbing, not the idea",p:["I'm currently held up on the AWS side — registering my ID. In honesty it's purely a timing issue: my ID hasn't been accepted yet and there's a ticket open with them. The idea and the design are ready; I'm waiting on a door to open. Sharing it half-built on purpose, because \"in progress\" is honest."]}
    ]
  },
  {
  ...
  /* ---------------- OTHER ---------------- */
  {
    id:"website", cat:"other", status:"wip", kicker:"Built with Claude · this very site",
    name:"This Website",
