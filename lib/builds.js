...
const CATEGORIES = {
  ...
  business:{title:"Business",      count:"06 · tools & case studies",note:"Real things I built for my own businesses, plus tools and guides for other small shops. These teach by example. Swouch is one I'm growing myself, so it's here to show, not to take."},
